  ...
  return (
    <div className="w-64 bg-[#1f5aad] text-white flex flex-col h-full">
      ...
      {user && (
        <div className="p-4 border-b border-blue-700 flex items-center">
          ...
          <div>
            ...
            <div className="text-xs text-blue-200">{user.role.toLowerCase()}</div>
          </div>
        </div>
      )}
      ...
      <div className="p-4 border-t border-blue-700">
        <Button variant="ghost" className="w-full justify-start text-white hover:bg-blue-700/50 px-4" onClick={logout}>
